...
var crud = require(__dirname + '/controllers/crud');
...
db.connect(host, port, name);var app = module.exports = express();
...
// Crud
app.get('/crud/:collection?', crud.crud);
app.get('/crud/:collection/:id?', crud.crud);
app.post('/crud/:collection', crud.crud);
app.put('/crud/:collection/:id', crud.crud);
app.delete('/crud/:collection/:id', crud.crud);
